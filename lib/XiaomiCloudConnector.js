...
class XiaomiCloudConnector {
    ...
    init(authObj) {
        if (authObj) {
            ...
            if (authObj.cookies && typeof authObj.cookies === 'object') {
    ...
    async loginStep2() {
        ...
        if (typeof this.captCode === 'string' && this.captCode && this.captCode !== 'true') {
        ...
        try {
            ...
            if (data.captchaUrl) {
                ...
                // Download captcha with the same cookie jar so ICK/session stays valid
                ...
                this.logger.info('CloudApi-Login requires captcha – please solve it in adapter settings');
                return {
